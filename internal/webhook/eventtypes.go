...
var EventTypes = []EventType{
	...
	{"trunk.updated", "A trunk was changed."},
	{"trunk.deleted", "A trunk was deleted."},
	{"trunk.status_changed", "A trunk's registration or reachability changed (registered, unreachable, ...)."},
