...
func TestRouteCommand(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{[]string{"test", "050 123 4567", "--from", "101"}, []string{"Mobile number: +971 50 123 4567.", "no outside lines"}},
		{[]string{"test", "--from", "101", "999"}, []string{"Emergency number (police): 999.", "Always allowed"}},
