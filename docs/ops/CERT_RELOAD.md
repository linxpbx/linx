...
| Front doors (Pangolin's Traefik, `linx-sni` HAProxy) | Nothing: they pass TLS through undecrypted by name (Phase 1C step 6), so they hold no Linx certificate; browsers get the control plane's and coturn's, reloaded as above | No |
